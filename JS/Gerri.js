...
//   const normalizedString = inputString.toLowerCase().replaceAll(' ', '');
//   const letters = normalizedString.split('');
//   const newArr = [];
...
//   }
//   let reversedStr = newArr.join('');
//   return inputString.toLowerCase() === reversedStr;
// };
// const strings = [
//   'Tenet', // true
...
const withdraw = function (amount, balance) {
  if (amount === 0) {
    console.log('vvedi summu bolshe 0');
    return;
  }
  if (amount > balance) {
    console.log('nedostatochno sredstv');
    return;
  }
  console.log('operciya ok');
};
